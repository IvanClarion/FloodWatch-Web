...
class DuplicationDetection:
    ...
    def find_duplicates_in_list(records: list, fields: list, context_label: str = "records") -> list:
        ...
        prompt = DuplicationDetection._build_internal_detection_prompt(records, fields, context_label)
        raw = generate_response(prompt)
        return DuplicationDetection._parse_ai_response(raw)
    ...
    def find_duplicates_against_existing(incoming: list, existing: list, fields: list, context_label: str = "records") -> list:
        ...
        prompt = DuplicationDetection._build_detection_prompt(incoming, existing, fields, context_label)
        raw = generate_response(prompt)
        return DuplicationDetection._parse_ai_response(raw)
    ...
    def detect_duplicate_utilities(incoming: list, existing: list) -> list:
        ...
        """
        return DuplicationDetection.find_duplicates_against_existing(
            incoming, existing,
